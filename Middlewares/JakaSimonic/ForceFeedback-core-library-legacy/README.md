...
-on SET_FEATURE report id 5(+1) use FfbOnCreateNewEffect

-on GET_FEATURE report id 6(+1) use FfbOnPIDBlockLoad

-on GET_FEATURE report id 7(+1) use FfbOnPIDPool

-on GET_REPORT report id 2(+1) use FfbOnPIDStatus
